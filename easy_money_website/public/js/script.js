...
document.addEventListener('DOMContentLoaded', function () {
      ...
      var myChart = new Chart(myCanvas, {
        ...
        data: {
          ...
          datasets: [{
            ...
            tension: 0.4,
            backgroundColor: ['rgba(28, 4, 252, 1)'],
            borderColor: ['rgba(28, 4, 252, 1)'],
            borderWidth: 4
          }, {
            label: 'This week',
            data: [2000, 3600, 1600,],
            cubicInterpolationMode: 'monotone',
            tension: 0.4,
            backgroundColor: ['rgba(61, 208, 10, 1)'],
            borderColor: ['rgba(61, 208, 10, 1)'],
            borderWidth: 4
          }]
        },
        options: {
  ...
  function addData() {
    ...
    if (charts.hasOwnProperty('revenues')) {
      charts.revenues.options.scales.x.grid.color = gridLine;
      charts.revenues.options.plugins.title.color = titleColor;
      charts.revenues.options.scales.y.ticks.color = titleColor;
      charts.revenues.options.scales.x.ticks.color = titleColor;
      charts.revenues.update();
    }
  }
